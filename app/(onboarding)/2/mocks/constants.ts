...
export const industries = [
  ...
  { value: "warehousing", label: "Entreposage" },
  {
    ...
    label: "Capital-risque & Private Equity",
  },
  {
    value: "transportation_trucking_railroad",
    label: "Transport / Camionnage / Chemin de fer",
  },
  ...
  { value: "security_investigations", label: "Sécurité & Enquêtes" },
  {
    ...
    label: "Énergies renouvelables & Environnement",
  },
  {
    value: "recreational_facilities_services",
    label: "Équipements & Services récréatifs",
  },
  ...
  { value: "railroad_manufacture", label: "Fabrication de chemins de fer" },
  {
    ...
    label: "Relations publiques & Communication",
  },
  { value: "public_policy", label: "Politique publique" },
  {
    value: "professional_training_coaching",
    label: "Formation professionnelle & Coaching",
  },
  {
    value: "primary_secondary_education",
    label: "Éducation primaire & secondaire",
  },
  ...
  { value: "commercial_real_estate", label: "Immobilier commercial" },
  {
    ...
    label: "Sécurité informatique & réseaux",
  },
  ...
  { value: "education_management", label: "Gestion de l'éducation" },
  {
    ...
    label: "Fabrication électrique / électronique",
  },
  ...
  { value: "health_wellness_fitness", label: "Santé, Bien-être & Fitness" },
  {
    ...
    label: "Résolution alternative des litiges",
  },
  ...
  { value: "import_export", label: "Import / Export" },
  {
    ...
    label: "Services aux individus & familles",
  },
  ...
  { value: "libraries", label: "Bibliothèques" },
  {
    ...
    label: "Logistique & Chaîne d'approvisionnement",
  },
  ...
  { value: "marketing_advertising", label: "Marketing & Publicité" },
  {
    ...
    label: "Génie mécanique ou industriel",
  },
